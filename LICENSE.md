...
# preignition - Terms and conditions

## Preamble: 
This Agreement, governs the relationship between pre-ignition app users  and pre-ignition, a partnership under the laws of whose principal place of business is {location} (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using pre-ignition (hereinafter: The Software) created and owned by Licensor, as detailed herein
